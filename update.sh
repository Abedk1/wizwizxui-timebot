...
do
	case $opt in
		"Update bot")
			...
			sleep 3
			git clone https://github.com/abedk1/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
...
# 			fi
		...
		"Update panel")
			...
			if [ -z "$destination_dir" ]; then
			 ...
			 cd /var/www/html/
			 wget -O wizwizpanel.zip https://github.com/abedk1/wizwizxui-timebot/releases/download/7.5.3/wizwizpanel.zip
